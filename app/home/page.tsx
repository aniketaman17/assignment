...
import DexterImage from '../../components/DexterImage'; // Adjust the path as needed
import BackgroundVectors from '../../components/BackgroundVectors'; // Adjust the path as needed
