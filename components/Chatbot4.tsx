...
const Chatbot4 = () => {
  ...
  const handleGroup19Click = () => {
    router.push('/chatbot5');
  };
  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-dark"
      ...
      <div className="absolute cursor-pointer"
           ...
           onClick={handleGroup19Click}>
        <Image src="/images/ggg 2.svg" alt="Start a new conversation" layout="fill" />
        ...
        <div className="absolute" style={{ width: '735px', height: '300px', top: '288px', left: '260px', gap: '0px', opacity: '0px' }}>
          <Image src="/images/text.png" alt="Dexter Chatbot Logo" width={735} height={300} />
        </div>
      </div>
    </div>
  );
